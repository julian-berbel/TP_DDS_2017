...
public class IndicatorGreaterThanValueWindow extends IndicatorStatisticCompareWindow
{
	...
	protected void addActions(Panel actions) {
		...
		{
			FilterCriterion newCriterion = FilterCriteria.indicatorValueHigherThan(this.getModelObject().getSelectedIndicator(), this.getModelObject().getValue(), this.getModelObject().getNumberYears());
