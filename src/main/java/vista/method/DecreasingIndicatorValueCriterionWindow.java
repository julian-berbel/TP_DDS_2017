...
public class DecreasingIndicatorValueCriterionWindow extends SimpleWindow<DecreasingIndicatorValueCriterionVM>
{
	...
	{
		this.setTitle("Indicador decreciente en una cantidad de años");
		...
		{
			FilterCriterion newCriterion = FilterCriteria.decreasingIndicatorValue(this.getModelObject().getSelectedIndicator(), this.getModelObject().getNumberYears());
