...
public class IncreasingIndicatorValueCriterionWindow extends SimpleWindow<IncreasingIndicatorValueCriterionVM> 
{
	public IncreasingIndicatorValueCriterionWindow(WindowOwner owner)
	{
		super(owner, new IncreasingIndicatorValueCriterionVM());
	}
