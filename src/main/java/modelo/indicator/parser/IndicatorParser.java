...
/** Main production. */
  final public Operable Start() throws ParseException {Operable exp;
    exp = Expression();
    jj_consume_token(0);
{if ("" != null) return exp;}
  ...
  final public Operable Expression() throws ParseException {Operable op1, op2;
    if (jj_2_1(100)) {
      op1 = Term();
      jj_consume_token(4);
      op2 = Expression();
...
{if ("" != null) return op1;}
  ...
  final public Operable Term() throws ParseException {Operable op1, op2;
    if (jj_2_4(100)) {
      op1 = Factor();
      jj_consume_token(6);
      op2 = Term();
...
{if ("" != null) return op1;}
  ...
  final public Operable Factor() throws ParseException {Operable op;
    if (jj_2_7(100)) {
      jj_consume_token(8);
      op = Expression();
      jj_consume_token(9);
...
/** An Identifier. */
  final public Operable Identifier() throws ParseException {Operable op;
    if (jj_2_11(100)) {
      op = Indicator();
    } else if (jj_2_12(100)) {
      op = Calculation();
...
{if ("" != null) return IndicatorRepository.getInstance().getByName(t.image);}
    throw new Error("Missing return statement in function");
  }

  final public Operable Calculation() throws ParseException {Token t;
    jj_consume_token(11);
    t = jj_consume_token(IDENTIFIER);
...
{if ("" != null) return new Constant(new BigDecimal(t.image));}
    throw new Error("Missing return statement in function");
  }
