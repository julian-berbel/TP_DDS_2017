...
public class IndicatorMedianLessThanValue extends FilterCriterion
{
	...
	public IndicatorMedianLessThanValue(String name,Indicator indicator, BigDecimal value, int years) 
	{
		super(name);
		this.value=value;
