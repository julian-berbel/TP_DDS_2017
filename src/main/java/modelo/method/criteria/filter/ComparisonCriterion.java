...
public class ComparisonCriterion {
  ...
  public static final ComparisonCriterion HigherThan = new ComparisonCriterion(" mayor a ", " decreciente",
      result -> result > 0);
  public static final ComparisonCriterion LowerThan = new ComparisonCriterion(" menor a ", " creciente",
      result -> result < 0);
