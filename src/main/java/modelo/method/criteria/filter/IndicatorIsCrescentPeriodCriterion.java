...
public class IndicatorIsCrescentPeriodCriterion extends FilterCriterion
{
	...
	public IndicatorIsCrescentPeriodCriterion(String name,Indicator indicator, int years) 
	{
		super(name);
