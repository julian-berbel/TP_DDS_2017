...
public class IndicatorHigherThanValue extends FilterCriterion
{
	...
	public IndicatorHigherThanValue(String name,Indicator indicator, BigDecimal value, int years) 
	{
		super(name);
		this.value=value;
