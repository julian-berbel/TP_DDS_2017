...
public class SessionFactoryRule implements MethodRule {
  ...
  private void createSessionFactory(Class<?>... clases) // Class<?> especifica
                                                        // que es cualquier tipo
                                                        // de clase
  { // Esos puntos suspensivos despeus del tipo de dato indican que le paso un
    // nro variable de argumentos al metodo
    Configuration configuration = new Configuration();

    for (Class<?> clase : clases) {
      configuration.addAnnotatedClass(clase); // Esto agrega las clases a
                                              // persistir a la configuracion de
                                              // hibernate
    }

    // Lo siguiente agrega las propiedades que deberian estar en el
    // persistence.xml
